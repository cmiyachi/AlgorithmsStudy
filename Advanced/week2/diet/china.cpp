...
main()
{
  ...
  while (1) {
    cout << "Warning: The current version can only handle LP in standard form!!\n";
    ...
    cout << "Input the " << m << " by " << n 
	 << " coefficients of the LHS of equality constraints:\n";
    for (int i=0; i<m; i++) for (int j=0; j<n; j++) cin >> A[i][j];

    cout << "Input the " << m
	 << " constants of the RHS of equality constraints:\n"; 
